...
class TestDistinctiveness:
    ...
    def test_undirected(self):
        G = small_undir_G()
        DC1 = distinctiveness(G, normalize=False, alpha=1,
                                 measures=["D1", "D2", "D3", "D4", "D5"])
        DC2 = distinctiveness(G, normalize=False, alpha=2,
                                 measures=["D1", "D2", "D3", "D4", "D5"])
    ...
    def test_directed(self):
        G = small_dir_G()
        DC1dir = distinctiveness(G, normalize=False, alpha=1,
                                    measures=["D1", "D2", "D3", "D4", "D5"])
        DC2dir = distinctiveness(G, normalize=False, alpha=2,
                                    measures=["D1", "D2", "D3", "D4", "D5"])
...
# Will say something in case of errors
foo = TestDistinctiveness()
foo.test_directed()
foo.test_undirected()